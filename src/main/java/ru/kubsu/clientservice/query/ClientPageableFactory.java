...
/**
 * Фабрика {@link Pageable} для поиска клиентов.
 */
public final class ClientPageableFactory {

    private static final int DEFAULT_PAGE_NO = 0;
    private static final int DEFAULT_PAGE_SIZE = 20;

    private ClientPageableFactory() {
    }
     ...
     */
    public static Pageable from(ClientQueryParams params, OrderSpecifier<?> orderSpecifier) {
